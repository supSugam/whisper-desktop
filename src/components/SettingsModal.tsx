...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="overlay settings-overlay open" onClick={(e) => {
      ...
      <div className="modal-card">
        ...
        <div className="modal-body">
            ...
            <>
              ...
              <div className="form-row">
                ...
                <ToggleSwitch
                  ...
                  onChange={(checked) => updateSetting('shortcutEnabled', checked)}
                />
              </div>
              
              <ShortcutRecorder />
              
              <div className="form-row" style={{ alignItems: 'flex-start', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
                  ...
                  <SegmentedControl
                    ...
                    onChange={(value) => updateSetting('recordMode', value as 'toggle' | 'hold')}
                    dataKey="mode"
                  />
                </div>
          ...
          <div className="form-row">
            <div style={{ fontSize: '0.8rem', opacity: 0.6 }}>History management is now on the main screen.</div>
          </div>
          ...
          {/* Local Model Section */}
          {config.transcriptionEngine === 'local' && (
            <div id="local-model-section" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div className="form-label">Local Models (CPU Optimized)</div>
              <ModelManager />
              
              <div className="form-group">
                <div className="form-row">
                    <label className="form-label">Translate to English</label>
                    <ToggleSwitch
                    checked={config.localTranslate || false}
                    onChange={(checked) => updateSetting('localTranslate', checked)}
                    />
                </div>
          ...
          <div 
            ...
            style={{ opacity: config.transcriptionEngine === 'local' ? 0.5 : 1 }}
          >
            Authentication
          </div>
          <div className="form-group" style={{ 
            opacity: config.transcriptionEngine === 'local' ? 0.5 : 1,
            pointerEvents: config.transcriptionEngine === 'local' ? 'none' : 'auto'
          }}>
          ...
          <div className="form-group" style={{
            ...
            />
            <div className="form-text" style={{ fontSize: '0.75rem', color: '#aaa', marginTop: '4px' }}>
          ...
          <div className="guide-box">
            ...
            <div className="guide-method">
              <div style={{ fontWeight: 600, color: '#fff', marginBottom: '6px' }}>Method 1: Developer Tools (Recommended)</div>
              <div className="guide-step"><span className="step-num">1</span> Go to <a href="https://chatgpt.com" target="_blank">chatgpt.com</a></div>
              <div className="guide-step"><span className="step-num">2</span> Press <code>F12</code> → <strong>Application</strong> tab → <strong>Cookies</strong></div>
              <div className="guide-step"><span className="step-num">3</span> Select <code>chatgpt.com</code> from list</div>
              <div className="guide-step"><span className="step-num">4</span> Copy value of <code>__Secure-next-auth.session-token</code></div>
            </div>

            <div className="or-divider">— OR —</div>

            <div className="guide-method">
              <div style={{ fontWeight: 600, color: '#fff', marginBottom: '6px' }}>Method 2: Browser Extension</div>
              ...
              <div className="guide-step">While you're at chatgpt.com, open extension → Find <code>__Secure-next-auth.session-token</code> → Copy value.</div>
        ...
        <div className="modal-footer">
          ...
          <button className="btn-text-only" onClick={handleResetDefaults}>Reset Defaults</button>
        </div>
      </div>
    </div>
  );
